...
public class BoardDao {
	...
	public ArrayList<Board> selectTitleList(Connection conn, String boardTitle, int currentPage, int limit) {
		ArrayList<Board> list = new ArrayList<Board>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
	...
	public ArrayList<Board> selectWriterList(Connection conn, String writer, int currentPage, int limit) {
		...
		String query = "select * from board where board_writer like ?";
	...
	public ArrayList<Board> selectDateList(Connection conn, Date begin, Date end, int currentPage, int limit) {
		...
		String query = "select * from board where board_date between ? and ?";
