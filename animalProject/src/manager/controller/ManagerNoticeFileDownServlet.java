...
/**
 * Servlet implementation class ManagerNoticeFileDownServlet
 */
@WebServlet("/manndown")
public class ManagerNoticeFileDownServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManagerNoticeFileDownServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 게시글 첨부파일 다운로드 처리용 컨트롤러
				...
				// 2.
				String originalFileName = request.getParameter("mnofile");
				String renameFileName = request.getParameter("mnrfile");
