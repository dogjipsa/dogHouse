function info_execDaumPostcode() {
    var mapContainer = document.getElementById('addrUpdate'), // 지도를 표시할 div
        mapOption = {
    ...
    new daum.Postcode({
        oncomplete: function(data) {
            ...
            if(data.userSelectedType === 'R'){
                ...
                document.getElementById("info_extraAddress").value = extraAddr;
            
            } else {
                document.getElementById("info_extraAddress").value = '';
            }
