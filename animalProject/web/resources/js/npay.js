const username = document.querySelector('.section1 input[name="username"]');
const addr = document.querySelector('.section1 input[name="addr"]');
const phone = document.querySelector('.section1 input[name="phone"]');
const email = document.querySelector('.section1 input[name="email"]');
...
function payInIt(datalist){
	...
	params: {payMethod: BootPay.method, callback2: '그대로 콜백받을 변수 2', customvar1234: '변수명도 마음대로'}
}).error(function (data) {
