...
<tr><td>첨부파일</td><td><input type="file" name="fupfile"></td></tr>
	<tr>
		<td></td>
		<td><textarea name="ir1" id="ir1" rows="10" cols="100" style="width:766px; height:412px; display:none;"></textarea></td>
		<td colspan="2" align="left">
		<input type="submit" onclick="submitContents(this);" value="등록하기" />
...
<script type="text/javascript"> 
	...
	nhn.husky.EZCreator.createInIFrame({
    	...
    	sSkinURI: "/doggybeta/SE2/SmartEditor2Skin.html",  //skin경로
    	htParams : {
