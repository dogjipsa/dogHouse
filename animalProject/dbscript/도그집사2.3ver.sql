...
ALTER TABLE MEMBER ADD(TITLE_IMG VARCHAR2(100));
...
INSERT INTO MEMBER VALUES ( 'tjrghekt', 'tjrghekt@naver.com', '홍길동', ' 서울시 광진구', '011-1234-1234', '학생', '2', 80000, sysdate, 1234,'N',NULL,NULL,NULL );
insert into member values ('admin', 1,1,1,1,1,0,10000,  sysdate, '1234','n',null,null,NULL);
...
insert into review values(seq_reviewno.nextval, 'tjrghekt', 1, '3', '리뷰내용1', null, null, default);
insert into review values(seq_reviewno.nextval, 'tjrghekt', 1, '4', '리뷰내용1', null, null, default);
insert into review values(seq_reviewno.nextval, 'tjrghekt', 1, '3', '리뷰내용1', null, null, default);
commit;